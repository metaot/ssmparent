		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/user/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input id="input_name" type="text" class="form-control" name="username"
								placeholder="用户名称" value="" onchange="checkName(this)">
						</div>
				...
				<div class="box-tools text-center">
					<button id="btn_sub" type="submit" class="btn bg-maroon">保存</button>
